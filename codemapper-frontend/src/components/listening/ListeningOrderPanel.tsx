...
export function ListeningOrderPanel() {
  ...
  return (
    <div className="pointer-events-auto absolute left-3 top-[64px] z-20 flex max-h-[calc(100vh-200px)] w-[300px] flex-col overflow-hidden rounded-lg border border-[var(--border-silver)] bg-[var(--bg-card)]/60 shadow-[var(--shadow-lg)] backdrop-blur-md">
